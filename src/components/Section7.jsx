    ...
    <>
      <div id="section7" className={styles.container}>
        ...
        <p className={styles.text}>
          En fouillant dans le grenier sombre du chalet, les amis trouvent une
          plaque en métal gravée de symboles anciens et énigmatiques. Au-dessus
          de la plaque, une phrase mystérieuse est gravée dans le bois :
